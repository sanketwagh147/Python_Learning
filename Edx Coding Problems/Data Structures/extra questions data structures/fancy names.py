...
def fancy_me(a_list_of_strings):
    output_list = []
    for each_string in a_list_of_strings:
        # print(each_string)
        a_list = each_string.split()
        # print(a_list)
        a_fancy_string = a_list[0][0]+"."+ " "+a_list[1][0]+ " " + a_list[2]
        output_list.append(a_fancy_string)
