...
#Add your code here!
def inside_search(a_list_of_string, search_string):
    index_list=[]
    for search in range(0,len(a_list_of_string)):
        # print(a_list_of_string[search])
        if search_string in a_list_of_string[search]:
            index_list.append(search)
            # print("yes")
    return index_list
