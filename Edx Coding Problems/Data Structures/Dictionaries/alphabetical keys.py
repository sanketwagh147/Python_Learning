...
#Add your code here!
def alphabetical_keys(a_dictionary):
    ret_string =""
    for key in sorted(a_dictionary):
        print(key)
        ret = key+": "+ str(a_dictionary[key])
        ret_string = ret_string+ret+"\n"
        # return "".join(key+": "+ str(a_dictionary[key]))
    return ret_string
...
# a_dictionary = {'Blount, Hermina': 32, 'Mancuso, Mellie': 29, 'Cambridge, Christal': 42, 'Peirce, Monserrate': 32, 'Socha, Clara': 10, 'Plant, Aracelis': 47, 'Knutson, Morton': 55}
