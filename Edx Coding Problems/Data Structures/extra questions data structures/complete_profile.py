...
#Add your code here!
def complete_profile(a_dictionary):
    a_dictionary["name"] = a_dictionary["first"] + " " + a_dictionary["last"]
    # print(a_dictionary)
    a_dictionary["full_name"] =a_dictionary["title"]+ " " + a_dictionary["first"] + " " + a_dictionary["middle"] + " " + a_dictionary["last"]
    short_name = a_dictionary["name"][0]
    a_dictionary["short_name"] = short_name + " " + a_dictionary["last"]
    return a_dictionary
