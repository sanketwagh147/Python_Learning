...
#Add your code here!
def geometric_rainfall(a_list_of_integers):
    total = 1
    count = 0
    for i in range(0, len(a_list_of_integers)):
        print(a_list_of_integers[i])
        if a_list_of_integers[i] == -1:
            break

        else:
            total *= a_list_of_integers[i]
            count +=1
