...
def calculate_score(a_dictionary_answer, a_dictionary_of_correct_answers):
    count = 0
    if len(a_dictionary_answer) == len(a_dictionary_of_correct_answers):
        # print("equal lengths")
        for key in a_dictionary_answer.keys():
            student_answers = a_dictionary_answer[key]
            # print(student_answers, end=" ")
            correct_answers = a_dictionary_of_correct_answers[key]
