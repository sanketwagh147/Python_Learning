...
def wish_list(a_list_of_string, a_string, a_cost, a_budget):
    if a_string in a_list_of_string:
        if a_cost <= a_budget:
            ret_string = "You should buy a "+a_string+"!"
            return ret_string
        else:
            ret_string="You should save up for a "+a_string+"!"
            return ret_string
    else:
        ret_string="You probably don't want to buy a "+a_string+"."
        return ret_string
