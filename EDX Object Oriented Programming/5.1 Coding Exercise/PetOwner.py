...
def get_owner_string(a_instance_pet):
    return a_instance_pet.name.first + " " + a_instance_pet.name.last+ "'s owner is " \
           + a_instance_pet.owner.name.first + " " + a_instance_pet.owner.name.last + "."
