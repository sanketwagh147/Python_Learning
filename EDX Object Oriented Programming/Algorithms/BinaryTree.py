...
def binary_tree_search(a_node, a_search_int):
    # print(a_node.value,a_search_int)
    if a_node == None:
        return False
    elif a_search_int == a_node.value:
        return True
    else:
        if a_node.value > a_search_int:
            return binary_tree_search(a_node.left, a_search_int)
        else:
            return binary_tree_search(a_node.right, a_search_int)
