...
#Add your code here!
def calculate_modifier(stab, type1, critical, other, random):
    return stab * type1 * critical * other * random

def calculate_damage(stab, type1, critical1, other, random, level, attack, defense, base):
    return (((2 * level + 10)/250) * (attack/defense) * base + 2) * calculate_modifier(stab, type1,critical1,other,random)
