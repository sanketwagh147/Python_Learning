...
#Add your code here!
def next_fib(a_list_of_integers, an_integer):
    while_count = an_integer

    while while_count>0:
        while_count -=1
        append_int = a_list_of_integers[-1]+a_list_of_integers[-2]
        a_list_of_integers.append(append_int)
    return a_list_of_integers
