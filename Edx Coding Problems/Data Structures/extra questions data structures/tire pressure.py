...
#Add your code here!
def tire_pressure(a_list_of_integers):
    valid_pressure = []
    for each in a_list_of_integers:
        if each>=15 and each<=55:
            valid_pressure.append(each)
    print(valid_pressure)
    average_pressure = sum(valid_pressure[-5:])/5
